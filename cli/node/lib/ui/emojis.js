...
exports.EMOJIS = {
    ...
    HEDGEHOG: (0, node_emoji_1.get)('hedgehog'),
    CONFIG: (0, node_emoji_1.get)('gear'),
    WARNING: (0, node_emoji_1.get)('warning'),
    FIRE: (0, node_emoji_1.get)('fire'),
    OK: (0, node_emoji_1.get)('ok'),
    CHECK: (0, node_emoji_1.get)('white_check_mark'),
};
