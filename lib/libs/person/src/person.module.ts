import { PersonCustomModule } from './person/person-custom/person-custom.module';
import { PersonCustomTypeModule } from './person-custom-type/person-custom-type.module';
import { PersonAddressModule } from './person/person-address/person-address.module';
import { PersonAddressTypeModule } from './person-address-type/person-address-type.module';
import { PersonContactModule } from './person/person-contact/person-contact.module';
import { PersonContactTypeModule } from './person-contact-type/person-contact-type.module';
import { PersonDocumentModule } from './person/person-document/person-document.module';
