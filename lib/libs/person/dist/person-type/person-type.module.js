...
const person_type_controller_1 = require("./person-type.controller");
...
exports.PersonTypeModule = PersonTypeModule = __decorate([
    (0, common_1.Module)({
        providers: [person_type_service_1.PersonTypeService],
        exports: [person_type_service_1.PersonTypeService],
        controllers: [person_type_controller_1.PersonTypeController],
        imports: [
...
//# sourceMappingURL=person-type.module.js.map