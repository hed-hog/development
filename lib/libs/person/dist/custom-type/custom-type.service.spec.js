...
describe('CustomTypeService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [
                custom_type_service_1.CustomTypeService,
                {
        ...
        service = module.get(custom_type_service_1.CustomTypeService);
...
//# sourceMappingURL=custom-type.service.spec.js.map