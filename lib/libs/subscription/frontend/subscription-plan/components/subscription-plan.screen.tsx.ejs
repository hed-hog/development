    ...
    <>
      ...
      <DataPanel
        ...
        columns={[
          ...
          {
            key: 'slug',
            header: t('subscription_plan.slug', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'duration',
            header: t('subscription_plan.duration', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'limit',
            header: t('subscription_plan.limit', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'name',
            header: t('subscription_plan.name', { ns: 'fields' }),
            isLocale: true
          }
        ]}
