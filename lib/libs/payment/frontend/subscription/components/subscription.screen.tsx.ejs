...
import { useSubscriptionDelete } from "@/features/blog/subscription";
...
export default function Page() {
  ...
  const { t } = useTranslation(["subscription", "modules", "actions"]);

  const openCreate = () => {
    const id = openSheet({
      title: t("create", { ns: "actions" }),
      description: t("createText", { ns: "subscription" }),
      children: () => (
  ...
  const openDelete = (items: Subscription[]) => {
    return confirm({
      ...
      description: t("deleteText", { ns: "subscription" }),
    })
      .then(() =>
        deleteSubscription(
  ...
  const openUpdate = (item: Subscription) => {
    const id = openSheet({
      ...
      description: t("editText", { ns: "subscription" }),
    });
    ...
    <>
      ...
      <DataPanel
        ...
        columns={[
          ...
          { key: "name", header: t("name", { ns: "subscription" }) },
        ]}
        ...
        menuActions={[
          {
            ...
            tooltip: t("editTooltip", { ns: "subscription" }),
          ...
          },
          {
            ...
            tooltip: t("deleteTooltip", { ns: "subscription" }),
            variant: "destructive",
            handler: (items: Subscription[]) => {
              openDelete(items);
            },
          ...
          },
          {
            ...
            tooltip: t("createTooltip", { ns: "subscription" }),
            variant: "default",
            handler: () => {
              openCreate();
            },
