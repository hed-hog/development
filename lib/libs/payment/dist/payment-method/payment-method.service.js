...
let PaymentMethodService = class PaymentMethodService {
    ...
    async list(paginationParams) {
        ...
        return this.paginationService.paginate(this.prismaService.payment_method, paginationParams, {
            where: {
                OR
            }
        });
    ...
    async get(id) {
        return this.prismaService.payment_method.findUnique({
            where: { id: id }
        });
    }
    async create(data) {
    ...
    async delete({ ids }) {
        ...
        return this.prismaService.payment_method.deleteMany({
            where: {
                id: {
                    in: ids
                }
