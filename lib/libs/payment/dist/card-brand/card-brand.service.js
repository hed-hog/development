...
exports.CardBrandService = void 0;
const pagination_1 = require("@hedhog/pagination");
const prisma_1 = require("@hedhog/prisma");
const common_1 = require("@nestjs/common");
let CardBrandService = class CardBrandService {
    ...
    async list(paginationParams) {
        ...
        return this.paginationService.paginate(this.prismaService.card_brand, paginationParams, {
            where: {
                OR
            }
        });
...
exports.CardBrandService = CardBrandService;
exports.CardBrandService = CardBrandService = __decorate([
...
//# sourceMappingURL=card-brand.service.js.map