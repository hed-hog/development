...
let DiscountTypeService = class DiscountTypeService {
    ...
    async list(paginationParams) {
        ...
        return this.paginationService.paginate(this.prismaService.discount_type, paginationParams, {
            where: {
                OR
            }
        });
    ...
    async get(id) {
        return this.prismaService.discount_type.findUnique({
            where: { id: id }
        });
    }
    async create(data) {
        return this.prismaService.discount_type.create({
            data
        });
    }
    async update({ id, data }) {
        return this.prismaService.discount_type.update({
            where: { id: id },
            data
        });
    }
    async delete({ ids }) {
        ...
        return this.prismaService.discount_type.deleteMany({
            where: {
                id: {
                    in: ids
                }
...
//# sourceMappingURL=discount-type.service.js.map