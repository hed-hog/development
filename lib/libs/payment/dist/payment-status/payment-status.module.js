...
const payment_status_controller_1 = require("./payment-status.controller");
let PaymentStatusModule = class PaymentStatusModule {
};
exports.PaymentStatusModule = PaymentStatusModule;
exports.PaymentStatusModule = PaymentStatusModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [payment_status_controller_1.PaymentStatusController],
        providers: [payment_status_service_1.PaymentStatusService],
        exports: [payment_status_service_1.PaymentStatusService]
    })
], PaymentStatusModule);
