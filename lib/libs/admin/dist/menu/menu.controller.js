...
let MenuController = class MenuController {
    ...
    async listRoles(menuId) {
        return this.menuService.listRoles(menuId);
    }
    async listScreens(menuId) {
...
__decorate([
    (0, common_1.Patch)(':menuId/screens'),
    __param(0, (0, common_1.Param)('menuId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_ids_dto_1.UpdateIdsDTO]),
