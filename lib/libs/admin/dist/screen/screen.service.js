...
let ScreenService = class ScreenService {
    ...
    async updateRoutes(screenId, { ids }) {
        ids = (await this.prismaService.routes.findMany({
            where: {
                id: {
                    in: ids,
                },
    ...
    async listRoutes(screenId, paginationParams) {
        return this.paginationService.paginate(this.prismaService.routes, paginationParams, {
            include: {
                route_screens: {
                    where: {
                        screen_id: screenId,
