...
let ScreenController = class ScreenController {
    ...
    async listRoles(screenId, paginationParams) {
        return this.screenService.listRoles(screenId, paginationParams);
    }
    async listRoutes(screenId, paginationParams) {
...
__decorate([
    (0, common_1.Get)(':screenId/roles'),
    __param(0, (0, common_1.Param)('screenId', common_1.ParseIntPipe)),
    __param(1, (0, pagination_1.Pagination)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], ScreenController.prototype, "listRoles", null);
__decorate([
    (0, common_1.Get)(':screenId/routes'),
    __param(0, (0, common_1.Param)('screenId', common_1.ParseIntPipe)),
    __param(1, (0, pagination_1.Pagination)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Object]),
    __metadata("design:returntype", Promise)
], ScreenController.prototype, "listRoutes", null);
__decorate([
    (0, common_1.Patch)(':screenId/roles'),
    __param(0, (0, common_1.Param)('screenId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_ids_dto_1.UpdateIdsDTO]),
    __metadata("design:returntype", Promise)
], ScreenController.prototype, "updateRoles", null);
__decorate([
    (0, common_1.Patch)(':screenId/routes'),
    __param(0, (0, common_1.Param)('screenId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_ids_dto_1.UpdateIdsDTO]),
    __metadata("design:returntype", Promise)
], ScreenController.prototype, "updateRoutes", null);
__decorate([
