...
export default function UserCard() {
  ...
  return (
    <Card className='overflow-hidden'>
      <CardHeader className='bg-gradient-to-r from-blue-500 to-indigo-600 pb-2 pt-4'>
      ...
      <CardContent className='p-6'>
        <div className='flex items-center justify-between'>
          ...
          <button
            onClick={() => refetch()}
            disabled={isLoading}
            className='rounded-full p-2 transition-colors hover:bg-blue-100 disabled:opacity-50'
