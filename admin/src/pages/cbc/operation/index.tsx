    ...
    <>
      ...
      <DataPanel
        ...
        columns={[
          ...
          {
            key: 'margin_used',
            header: t('operation.margin_used', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'first_order',
            header: t('operation.first_order', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'mmr',
            header: t('operation.mmr', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'stop_loss',
            header: t('operation.stop_loss', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'start_time',
            header: t('operation.start_time', { ns: 'fields' }),
            isLocale: false
          },

          {
            key: 'end_time',
            header: t('operation.end_time', { ns: 'fields' }),
            isLocale: false
          }
        ]}
